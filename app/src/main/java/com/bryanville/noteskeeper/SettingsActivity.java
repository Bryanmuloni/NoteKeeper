...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference(getString(R.string.key_user_display_name)));
            bindPreferenceSummaryToValue(findPreference(getString(R.string.key_user_email_address)));
            bindPreferenceSummaryToValue(findPreference(getString(R.string.key_user_favorite_social)));
        }
